...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React18.useLayoutEffect : () => {
};

// node_modules/@radix-ui/react-radio-group/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var React24 = __toESM(require_react(), 1);
var useInsertionEffect2 = React19[" useInsertionEffect ".trim().toString()] || useLayoutEffect23;
...
function useSize(element) {
  const [size, setSize] = React21.useState(void 0);
  useLayoutEffect23(() => {
    if (element) {
...
var Radio = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
...
var RadioIndicator = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime12.jsx)(
      Primitive.span,
      {
...
var RadioGroupIndicator = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime13.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
