...
var DirectionContext2 = React18.createContext(void 0);
function useDirection2(localDir) {
  const globalDir = React18.useContext(DirectionContext2);
  return localDir || globalDir || "ltr";
}
...
function useSize(element) {
  const [size, setSize] = React19.useState(void 0);
  useLayoutEffect22(() => {
    if (element) {
